angular
  ...
  .module('Vidzy', ['ngRoute', 'ngResource'])
  ...
  .controller('AddVideoCtrl', ['$scope', '$resource', '$location',
  ...
  .controller('EditVideoCtrl', ['$scope', '$resource', '$location', '$routeParams',
  ...
  .controller('DeleteVideoCtrl', ['$scope', '$resource', '$location', '$routeParams',
    function($scope, $resource, $location, $routeParams){
